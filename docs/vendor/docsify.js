!(function () {
  ...
  (un.options = un.setOptions = function (e) {
    ...
    (un.parseInline = function (e, t) {
      ...
      try {
        ...
        return (
          t.walkTokens && un.walkTokens(n, t.walkTokens), an.parseInline(n, t)
        );
      } catch (e) {
        if (
          ((e.message +=
            ...
            C = {
              ...
              highlightElement: function (e, t, n) {
                ...
                if ((C.hooks.run('before-sanity-check', o), !o.code))
                  return (
                    C.hooks.run('complete', o), void (n && n.call(o.element))
                  );
  ...
  function On(e, r) {
    ...
    o.forEach(function (e, i) {
      'paragraph' === e.type &&
        (e.text = e.text.replace(new RegExp(l.source, 'g'), function (
          e,
          t,
          n,
          r
  ...
  (Vn._init = function () {
    ...
    (o.config = R(o)),
      ...
      V(o, 'init'),
      (e = new ('history' === ((e = (r = o).config).routerMode || 'hash') && f
        ? Dn
        : Pn)(e)),
      (r.router = e),
      jn(r),
